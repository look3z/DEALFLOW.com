...
<html>
  <head>
    <link rel="stylesheet" href="/pages/Reviews/globals.css" />
    <link rel="stylesheet" href="/pages/Reviews/styleguide.css" />
    <link rel="stylesheet" href="/pages/Reviews/style.css" />
    <title>Reviews</title>
  ...
  <body>
    <div class="reviews">
      <div class="div">
        <div class="overlap">
          <div class="b">
            <div class="overlap-group">
              <img class="rectangle" src="/pages/Reviews/img/rectangle-62.png" />
              <div class="banner"></div>
              <div class="seargh">
                <div class="overlap-group-2">
                  <img class="iconsax-linear" src="/pages/Reviews/img/iconsax-linear-searchnormal1.svg" />
          ...
          <div class="group">
            <img class="vector" src="/pages/Reviews/img/vector-3.svg" />
            <div class="group-2">
            ...
            <div class="group-3">
              ...
              <img class="img" src="/pages/Reviews/img/united-kingdom-gb.svg" />
            </div>
          </div>
          <img class="frame" src="/pages/Reviews/img/frame-70.svg" />
          <div class="frame-2">
            <img class="img-2" src="/pages/Reviews/img/iconsax-linear-category2.svg" />
            <div class="text-wrapper-5">Catalog</div>
          </div>
          <div class="group-4"><a href="/">
            <img class="LOGO" src="/pages/Reviews/img/logo.svg" />
            <div class="frame-wrapper"><img class="frame-3" src="/pages/Reviews/img/frame.svg" /></div>
          </a></div>
        </div>
        <div class="group-5">
          <div class="frame-4">
            <div class="item-card">
              <div class="overlap-group-3">
                <div class="card">
                  <div class="preview"><img class="image" src="/pages/Reviews/img/<?= $similar[0]['ImageURL'] ?>" /></div>
                ...
                <div class="cart"><img class="img-2" src="/pages/Reviews/img/vuesax-linear-shopping-cart-1.svg" /></div>
                <img class="like-button" src="/pages/Reviews/img/likebutton-1.svg" />
            ...
            <div class="item-card">
              <div class="overlap-group-3">
                <div class="card">
                  <div class="preview"><img class="image-2" src="/pages/Reviews/img/<?= $similar[3]['ImageURL'] ?>" /></div>
            ...
            <div class="item-card">
              <div class="overlap-group-3">
                <div class="card">
                  <div class="preview"><img class="image" src="/pages/Reviews/img/<?= $similar[4]['ImageURL'] ?>" /></div>
            ...
            <div class="item-card">
              <div class="overlap-group-3">
                <div class="card">
                  <div class="preview"><img class="image" src="/pages/Reviews/img/<?= $similar[2]['ImageURL'] ?>" /></div>
            ...
            <div class="item-card">
              <div class="overlap-group-3">
                <div class="card">
                  <div class="preview"><img class="image" src="/pages/Reviews/img/<?= $similar[1]['ImageURL'] ?>" /></div>
        ...
        <img class="vuesax-linear-home" src="/pages/Reviews/img/vuesax-linear-home-2-1.svg" />
        <img class="line" src="/pages/Reviews/img/line-4.svg" />
        ...
        <div class="text-wrapper-14">Reviews</div>
        ...
        <img class="group-6" src="/pages/Reviews/img/group-111.png" />
        ...
        <div class="frame-5">
          ...
          <img class="iconsax-linear-heart" src="/pages/Reviews/img/iconsax-linear-heart.svg" />
          <div class="frame-6">
            <img class="img-2" src="/pages/Reviews/img/vuesax-linear-shopping-cart-1.svg" />
            <div class="text-wrapper-23">Buy</div>
          </div>
          <img class="vuesax-linear-arrow" src="/pages/Reviews/img/vuesax-linear-arrow-swap-horizontal-1.svg" />
        </div>
        <footer class="FOOTER">
          <div class="f">
            <div class="overlap-group-4">
              ...
              <div class="group-7">
                ...
                <img class="img" src="/pages/Reviews/img/vuesax-linear-copyright.svg" />
              </div>
              <div class="social-media">
                <p class="text-wrapper-24">FOLLOW US ON SOCIAL MEDIA</p>
                <img class="vuesax-linear" src="/pages/Reviews/img/vuesax-linear-facebook-1.svg" />
                <img class="vuesax-linear-2" src="/pages/Reviews/img/vuesax-linear-instagram-1.svg" />
                <img class="twitter" src="/pages/Reviews/img/twitter.svg" />
              </div>
              <div class="teleph">
                <img class="img" src="/pages/Reviews/img/vuesax-linear-call.svg" />
        ...
        <div class="image-wrapper"><img class="image-3" src="/pages/Reviews/img/<?= $product['ImageURL'] ?>" /></div>
        <img class="frame-7" src="/pages/Reviews/img/frame-126.svg" />
        <div class="text-wrapper-31">Poor</div>
        <div class="text-wrapper-32">Fair</div>
        <div class="text-wrapper-33">Good</div>
        <div class="text-wrapper-34">Very good</div>
        <div class="text-wrapper-35">Excellent</div>
        <div class="frame-8">
          <div class="text-wrapper-36">Advantages</div>
          <div class="signup-button"></div>
        </div>
        <div class="frame-9">
          <div class="text-wrapper-36">Deficiencies</div>
          <div class="signup-button"></div>
        </div>
        <div class="frame-10">
          <div class="text-wrapper-36">Сommentary</div>
          <div class="signup-button"></div>
        </div>
        <div class="frame-11"><img class="vuesax-linear-3" src="/pages/Reviews/img/vuesax-linear-gallery-5.svg" /></div>
        <div class="frame-12"><img class="vuesax-linear-3" src="/pages/Reviews/img/vuesax-linear-gallery-5.svg" /></div>
        <div class="frame-13"><img class="vuesax-linear-3" src="/pages/Reviews/img/vuesax-linear-gallery-5.svg" /></div>
        <div class="frame-14"><img class="vuesax-linear-3" src="/pages/Reviews/img/vuesax-linear-gallery-5.svg" /></div>
        <div class="frame-15"><img class="vuesax-linear-3" src="/pages/Reviews/img/vuesax-linear-gallery-5.svg" /></div>
        <div class="frame-16"><img class="vuesax-linear-3" src="/pages/Reviews/img/vuesax-linear-gallery-5.svg" /></div>
        <div class="frame-17"><div class="text-wrapper-23">Submit</div></div>
      </div>
    </div>
  </body>
  <script>
